...
def parse_args():
    ...
    parser.add_argument("--prompt_dir", type=str, required=True, help="Path to the root of prompt audio files.")
    ...
    parser.add_argument("--output_path", type=str, required=True, help="Directory to save the output audio files.")
    parser.add_argument("--n_timesteps", type=int, default=16, help="Number of timesteps for synthesis.")
    parser.add_argument("--prompt_duration", type=int, default=None, help="Duration of the prompt audio in seconds.")
    parser.add_argument("--num_processes", type=int, default=1, help="Number of processes to use for inference.")
